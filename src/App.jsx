      ...
      <div className="relative w-full h-screen bg-[#050505] p-2 sm:p-4 md:p-8 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative w-full h-full bg-white rounded-[30px] md:rounded-[50px] overflow-hidden flex items-center justify-center selection:bg-black selection:text-white crt-bloom shadow-[0_0_20px_rgba(0,0,0,1)] ring-4 ring-[#111]">
          ...
          <div 
            ...
            style={{
              /* baseFrequency='0.2 0.9' heavily stretches the noise horizontally to create VHS/UHF dashes */
              ...
              /* Vibrantly forces SVG noise into high-contrast RGB/BLK/WHT pixels */
              filter: 'contrast(400%) saturate(500%) brightness(1.1)',
              /* Changed to 'normal' mixBlendMode so it confidently overlays BOTH the white bg and black text */
              opacity: 0.30,
              mixBlendMode: 'normal'
            }}
          ></div>
          ...
          <div className={`absolute inset-0 z-[48] bg-white pointer-events-none transition-opacity duration-300 ${bootStage === 'static' ? 'opacity-100' : 'opacity-0'}`}>
             <div 
              ...
              style={{
                backgroundImage: `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='turbulence' baseFrequency='0.2 0.9' numOctaves='2' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)'/%3E%3C/svg%3E")`,
